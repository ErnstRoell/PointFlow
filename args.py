...
def add_args(parser):
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="data/ShapeNetCore.v2.PC15k",
    ...
    parser.add_argument(
        "--fast_run", action="store_true", help="Make a fast run for testing"
    )
    parser.add_argument("--normalize", action="store_true", help="Normalize")
    parser.add_argument("--model", type=str, default="PointFlow", help="Model name")
    return parser
