...
from models.encoder_sparse import BaseModel as EncoderSparse
...
def main(args):
    ...
    elif args.model == "EncoderSparse":
        print("Loading Sparse Encoder")
        encoder_model = EncoderSparse.load_from_checkpoint(
            checkpoint_path=f"./trained_models/ectencoder_shapenet_{args.cates[0]}_sparse.ckpt"
        ).cuda()
